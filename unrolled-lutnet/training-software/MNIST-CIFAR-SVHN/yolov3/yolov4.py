#================================================================
#
#   File name   : yolov4_1.py
#   Description : main yolov3 & yolov4 functions with 0 widths and height being replaced the 3.5 and 4.5
#
#================================================================
import numpy as np
...
def bbox_giou(boxes1, boxes2):
    ...
    """
    With boxes1_area value equal to 0, union_area become 0
    Here we change the 0 value of boxes1_area with some small value instead
    """
    res = boxes1_area
    boxes1_area = boxes1_area + K.stop_gradient(tf.where(tf.equal(res, 0), 1.0e-06, res) - boxes1_area)
...
def compute_loss(pred, conv, label, bboxes, i=0, CLASSES=YOLO_COCO_CLASSES):
    ...
    # print("<---------------- Compute_loss giou_loss -------------->")
    # print(" giou : ",giou)
    # print(" input_size : ",input_size)
    # print(" bbox_loss_scale : ",bbox_loss_scale)
    # print(" respond_bbox : ", respond_bbox)
    ...
    # print("<---------------- Compute_loss conf_loss -------------->")
    # print(" conf_focal : ",conf_focal)
    # print(" respond_bgd : ",respond_bgd)
    # print(" iou: ", iou)
    # print(" max_iou: ", max_iou)
    # print("<---------------- Final Stage ------------->")
    # print(" giou_loss : ")
    # tf.print(giou_loss, summarize=-1)
    # print(" reduce sum giou_loss : ",tf.reduce_sum(giou_loss, axis=[1,2,3,4]))
    # print(" reduce mean giou_loss: ", tf.reduce_mean(tf.reduce_sum(giou_loss, axis=[1,2,3,4])))
