...
def YOLOv3_tiny(input_layer, NUM_CLASS):
    ...
    conv = upsample(conv)
    conv = tf.concat([conv, route_1], axis=-1)
    # Negative axis are interpreted as counting from the end of the rank, i.e., axis + rank(values)-th dimension.
...
#IOU intersection over union (intersection of bounding boxes)
