#================================================================
#
#   File name   : bnn_pruning.py
#   Created date: 2020-08-30
#   Description : functions that perform prunning to the model to the aimed LUT percentage 
#
#================================================================
...
def bnn_pruning(pruning_percentage):
    ...
    for key in bl:
        if 'binary' in key:	
            ...
            bl_pruning_mask = bl[key][key]["pruning_mask:0"]
            #bl_gamma = bl[key][key]["Variable:0"]
            zero_fill = np.zeros(np.shape(np.array(bl_w1)))
            pret_w1 = pretrained[key][key]["Variable_1:0"]
            pret_pruning_mask = pretrained[key][key]["pruning_mask:0"]
			#p_gamma = pretrained[key][key]["Variable:0"]
...
bnn_pruning(pruning_percentage)